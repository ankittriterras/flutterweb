...
// Model
class _MMoreDocuments {
  final String name;
  final String document;
  final String remarks;

  _MMoreDocuments({this.name, this.document, this.remarks});
...
// UI
class MoreDocuments extends StatefulWidget {
  @override
  _MoreDocumentsState createState() => _MoreDocumentsState();
}

class _MoreDocumentsState extends State<MoreDocuments> with TickerProviderStateMixin {
  ...
  List<_ColumnCellPairs> _columnCellPairs = [
    _ColumnCellPairs(cellTitle: "Document Name", modelClassKey: "name"),
    _ColumnCellPairs(cellTitle: "Document", modelClassKey: "document", identifier: 'uploaded_doc'),
    _ColumnCellPairs(cellTitle: "Remarks", modelClassKey: "remarks"),
  ];
  ...
  List<_MMoreDocuments> data = [
    _MMoreDocuments(
      name: "Electricity Bill",
      document: "Electricity Bill.pdf",
      remarks: "Please use this for proof of address",
    ),
  ];
  ...
  void _generateAnimationDependencies() {
    for (var i = 0; i < data.length; i++) {
      ...
      _animationList.add(Tween<double>(begin: 0, end: 230).animate(_controller));
  ...
  void _generateDataCells() {
    ...
    data.asMap().entries.forEach((element) {
      ...
      _MMoreDocuments entry = element.value;
...
class _RowEditForm extends StatefulWidget {
  ...
  const _RowEditForm({Key key, this.widgetIndex, this.toggleFunction}) : super(key: key);
  @override
