...
class _MCompanyDirectors {
  ...
  final bool authorizedSignatory;
...
class _CompanyDirectorsTableState extends State<CompanyDirectorsTable> with TickerProviderStateMixin {
  ...
  List<_ColumnCellPairs> _columnCellPairs = [
    ...
    _ColumnCellPairs(cellTitle: "Authorized Signatory", modelClassKey: "authorizedSignatory", identifier: "authorized_signatory"),
  ];
